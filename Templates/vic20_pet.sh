...
c1541 -attach "${STORY}_vic20_pet.d64" -write /mnt/c/Source/Puny-BuildTools/Templates/Interpreters/z3-vic "game-vic"
c1541 -attach "${STORY}_vic20_pet.d64" -write /mnt/c/Source/Puny-BuildTools/Templates/Interpreters/z3-pet "game-pet"
c1541 -attach "${STORY}_vic20_pet.d64" -write ${STORY}.z${ZVERSION} "z3 story,s"
c1541 -attach "${STORY}_vic20_pet.d64" -write /mnt/c/Source/Puny-BuildTools/Templates/Interpreters/config.seq "config,s"
