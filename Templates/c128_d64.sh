...
#compile
ruby /mnt/c/Source/Puny-BuildTools/Templates/Interpreters/Ozmoo/make.rb -ch -t:c128 -S1 -dc:2:9 -ss1:"${LABEL}" -ss2:"A Western by IkeC" -ss3:"${SUBTITLE}" -sw:6 -dm:0 ${STORY}.z${ZVERSION}
